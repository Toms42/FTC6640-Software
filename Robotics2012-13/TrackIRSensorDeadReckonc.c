...
const float fromCenter = 102.0;
const float fromSide = 81.5;
float deadReckon = 0;
...
//  raiseLift = true;
  ...
  moveDistanceAtSpeed(speedTarget, deadReckon*.7);
...
*/
 ...
 //     	speedAdjust(irac, speedModifier);
      ...
      if(numberOff >= 8)  // 3 sequential signals off to right
      {
			...
			else if (numberOff <= -8)  // 3 sequential signals off to left
			{
						 pointTurnDegrees(20,90,'l');
					   moveDistanceAtSpeed(20,20.5);
					   pointTurnDegrees(20,90,'r');
...
*/
 ...
 //     	speedAdjust(irac, speedModifier);
      ...
      displayText(6, "4", currentTenPtMovingAvg, oldTenPtMovingAvg);
		  ...
		  moveDistanceAtSpeed(20,(deadReckon*.3)-18);
